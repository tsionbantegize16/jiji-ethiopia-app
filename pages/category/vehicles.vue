  ...
  <div class="min-h-screen bg-[#C9F0EF] dark:bg-[#4F7F8F] py-8">
    <div class="container mx-auto px-4">
      ...
      <div class="bg-gradient-to-r from-[#2EC4B6] to-[#4F7F8F] rounded-xl shadow-lg p-8 mb-8 text-white">
        <h1 class="text-4xl font-bold mb-4">Vehicles in Ethiopia</h1>
        <p class="text-lg opacity-90">Find your perfect car, motorcycle, or commercial vehicle from trusted sellers</p>
      </div>
        ...
        <div class="bg-white dark:bg-[#4F7F8F] rounded-xl p-4 shadow-lg">
          <div class="flex items-center">
            ...
            <div>
              ...
              <p class="text-xl font-bold text-[#2EC4B6]">856</p>
            </div>
          </div>
        </div>
        <div class="bg-white dark:bg-[#4F7F8F] rounded-xl p-4 shadow-lg">
          <div class="flex items-center">
            ...
            <div>
              ...
              <p class="text-xl font-bold text-[#2EC4B6]">ETB 2,500,000</p>
            </div>
          </div>
        </div>
        <div class="bg-white dark:bg-[#4F7F8F] rounded-xl p-4 shadow-lg">
          <div class="flex items-center">
            ...
            <div>
              ...
              <p class="text-xl font-bold text-[#2EC4B6]">234</p>
            </div>
          </div>
        </div>
        <div class="bg-white dark:bg-[#4F7F8F] rounded-xl p-4 shadow-lg">
            ...
            <div class="p-4">
              ...
              <div class="mt-4 flex items-center justify-between">
                ...
                <div class="flex items-center space-x-2">
                  ...
                  <NuxtLink 
                    :to="`/category/vehicles/${vehicle.id}`"
...
definePageMeta({
  title: 'Vehicles in Ethiopia',
  description: 'Explore cars, motorcycles, and more for sale in Ethiopia.'
})
